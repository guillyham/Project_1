...
if (!empty($id_curso) && is_numeric($id_curso)):
  ...
  $sql = 'SELECT id, nome FROM tab_curso WHERE id = :id';
        ...
        <div class="card mb-3">
          <div class="card-header">
            <i class="fa fa-user-plus"></i>
              Editar Cadastro de Curso
          </div>
          <div class="card-body">
            <div class="table-responsive">

        <form action="action_curso.php" method="post" id='form-cadastro' enctype='multipart/form-data'>

          <div class="form-group">
            <label for="nome">Nome</label>
            <input type="nome" class="form-control" id="nome" name="nome" value= "<?=$curso->nome?>" placeholder="Infome o Nome" required="required" >
