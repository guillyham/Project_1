...
if (empty($termo)):
  ...
  $stm->execute();
  $aluno = $stm->fetchAll(PDO::FETCH_OBJ);

else:

  // Executa uma consulta baseada no termo de pesquisa passado como parâmetro
  $conexao = conexao::getInstance();
  $sql = 'SELECT id, nome, cpf FROM tab_aluno WHERE nome LIKE :nome';
  $stm = $conexao->prepare($sql);
            ...
            <div class="table-responsive">
              ...
              <?php foreach ($aluno as $aluno):?>
                  <tr class="active">
                    ...
                    <td><?=$aluno->cpf?></td>
                    <td>
                         <a href='editar.php?id=<?=$aluno->id?>' class="btn btn-primary">Editar</a>
