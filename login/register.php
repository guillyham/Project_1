            ...
            <div class="form-group">
              <div class="form-row">
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" id="exampleInputName" aria-describedby="nameHelp" placeholder="Informe o seu nome">
                </div>
                <div class="col-md-6">
                  <label for="exampleInputLastName">Sobrenome</label>
                  <input type="text" class="form-control" id="exampleInputLastName" aria-describedby="nameHelp" placeholder="Informe o seu sobrenome">
                </div>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <div class="form-row">
                ...
                <div class="col-md-6">
                  ...
                  <input type="password" class="form-control" id="exampleConfirmPassword" placeholder="Confirme a senha">
                </div>
              </div>
            </div>
