...
if (!empty($id_turma) && is_numeric($id_turma)):
  ...
  $sql = 'SELECT id, curso, turno, semestre, turma FROM tab_turma WHERE id = :id';
      ...
      <div class="container-fluid">
        ...
        <form action="action_turma.php" method="post" id='form-cadastro' enctype='multipart/form-data'>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="nome" name="nome" value= "<?=$turma->curso?>" placeholder="Infome o Nome do Curso" required="required">
            <span class='msg-erro msg-nome'></span>
          </div>

          <div class="form-group">
            <label for="cpf">CPF</label>
            <input type="cpf" class="form-control" id="cpf" maxlength="14" name="cpf" value= "<?=$turma->turno?>" placeholder="Informe o Turno" required="required">
            <span class='msg-erro msg-cpf'></span>
          </div>

          <div class="form-group">
            <label for="nome">Nome</label>
            <input type="text" class="form-control" id="nome" name="nome" value= "<?=$turma->semestre?>" placeholder="Infome o Semestre" required="required">
            <span class='msg-erro msg-nome'></span>
          </div>

          <div class="form-group">
            <label for="nome">Nome</label>
            <input type="text" class="form-control" id="nome" name="nome" value= "<?=$turma->turma?>" placeholder="Infome o Nome da Turma" required="required">
            <span class='msg-erro msg-nome'></span>
          </div>
