...
if (empty($termo)):
  ...
  $conexao = conexao::getInstance();
  $sql = 'SELECT id, nome FROM tab_curso WHERE nome LIKE :nome';
  $stm = $conexao->prepare($sql);
  ...
  <body class="fixed-nav sticky-footer bg-dark" id="page-top">
    ...
    <div class="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <form action="action_turma.php" method="post" id='form-cadastro' enctype='multipart/form-data'>
        ...
        <input type="hidden" name="acao" value="incluir" />
          ...
          <div class="form-group">
            <label for="semestre">Semestre <a data-toggle="tooltip" title="Informe o numero do semestre!">(?)</a></label></label>
            <input type='text' id="semestr" class="form-control" name="semestre" size='10'  value='' placeholder="Infome o Semestre" required="required" maxlength="2" onkeypress='return SomenteNumero(event)'>
            <span class='msg-erro msg-nome'></span>
          </div>

          <div class="form-group">
            <label for="turno">Turno <a data-toggle="tooltip" title="Informe o turno do Curso!">(?)</a></label></label>
            <input type="text" id="semestr" class="form-control" name="turno" placeholder="Infome o Turno" required="required" >
            <span class='msg-erro msg-nome'></span>
          </div>

          <div class="form-group">
            <label for="turma">Turma <a data-toggle="tooltip" title="Informe o Numero da turma!">(?)</a></label></label>
             <input type='text' id="semestr" class="form-control" name="turma" placeholder="Infome a turma" size='10'  value='' 
             required="required" maxlength="2" onkeypress='return SomenteNumero(event)'>
            <span class='msg-erro msg-nome'></span>
          </div>
