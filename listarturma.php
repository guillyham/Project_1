...
if (empty($termo)):
  ...
  $sql = 'SELECT id, turno, semestre, curso, turma FROM tab_turma';
  ...
  $conexao = conexao::getInstance();
  $sql = 'SELECT id, turno, semestre, curso, turma FROM tab_turma WHERE curso LIKE :curso';
  $stm = $conexao->prepare($sql);
...
<html lang="en">
  ...
  <?php if(!empty($turma));?>
            ...
            <div class="table-responsive">
              ...
              <?php foreach ($turma as $turma):?>
                  <tr class="active">
                    ...
                    <td><?=$turma->turma?></td>
                    <td>
                         <a href='javascript:void(0)' class="btn btn-danger link_exclusao" rel="<?=$turma->id?>">Excluir</a>
                    </td>
                  </tr>
              <?php endforeach;?>
    ...
    <script src="js/custom_turma.js"></script>
