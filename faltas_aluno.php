...
if (empty($termo)):
  ...
  $conexao = conexao::getInstance();
  $sql = 'SELECT id, nome_aluno, total_falta, total_nota FROM tab_dadosaluno WHERE nome_aluno LIKE :nome';
  $stm = $conexao->prepare($sql);
  ...
  <body class="fixed-nav sticky-footer bg-dark" id="page-top">
    ...
    <div class="content-wrapper">
      ...
      <div class="container-fluid">
        ...
        <form action="action_faltas.php" method="post" id='form-cadastro' enctype='multipart/form-data'>
        ...
        <input type="hidden" name="acao" value="incluir" />
          ...
          <div class="form-group">  
            <label for="faltas">Faltas <a data-toggle="tooltip" title="Faltas Maximas para ser reprovado = 20!">(?)</a></label><br>
            <input type='text' id="semestr" name="faltas" size='10'  value=''   maxlength="3" onkeypress='return SomenteNumero(event)'>
            <span class='msg-erro msg-nome'></span>
          </div>

        <div class="form-group">
            <label for="notas">Notas <a data-toggle="tooltip" title="Notas minimas para ser aprovado = 70!">(?)</a></label><br>
            <input type='text' id="semestr" name="notas" size='10' value=''    maxlength="2" onkeypress='return SomenteNumero(event)'>
            <span class='msg-erro msg-nome'></span>
          </div>
