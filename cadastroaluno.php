      ...
      <div class="container-fluid">
        ...
        <form action="action_aluno.php" method="post" id='form-cadastro' enctype='multipart/form-data'>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="nome" name="nome" placeholder="Infome o Nome" required="required">
            <span class='msg-erro msg-nome'></span>
          </div>

          <div class="form-group">
            <label >CPF</label>
            <input type="text" class="form-control" maxlength="14" name="cpf" placeholder="Infome o CPF" required="required" onkeydown="javascript: fMasc( this, mCPF );">
          </div>
